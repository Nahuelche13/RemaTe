...
public class MaquinariaDialog {
    ...
    public static Adw.Window New(MaquinariaVO? maquinaria, Gtk.Window parent) {
        ...
        // Type ComboRow
        var artTypeRow = builder.GetObject("_artTypeRow") as Adw.ComboRow;
        // PreferencesGroup
        ...
        artTypeRow.SetSelected(1);
        artTypeRow.SetActivatable(false);
        ...
        if (maquinaria != null) {
            ...
            // var año = DateTime.FromFileTime(maquinaria.año);
            // añoCalendarButton.SetLabel(año.ToShortDateString());
            // añoCalendar.Day =
        ...
        */
        ...
        addNewPropertyButton.OnClicked += (sender, e) => {
        ...
        addImageButton.OnClicked += async (sender, e) => {
            var openFileDialog = Gtk.FileDialog.New();
            openFileDialog.SetTitle("Seleccione una Imagen");
            var filters = Gio.ListStore.New(Gtk.FileFilter.GetGType());
            var filterImages = Gtk.FileFilter.New();
        ...
        saveButton.OnClicked += async (sender, e) => {
            if (maquinaria != null) {
                ...
                var (err, id) = await Maquinaria.Create(maquinaria);
                if (err != Errors.Ok) {
                    Utils.ShowCommonErrorDialog(parent, err);
                }
